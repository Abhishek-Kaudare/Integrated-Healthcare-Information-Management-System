...
import com.example.findmyhospital.InfoPage;
...
public class Maps3Activity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.mapNearBy3);
...
//            currentLocationMarker.remove();
            ...
            case R.id.nearby_hospitals:
                ...
                mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                    ...
                    public void onInfoWindowClick(Marker marker) {
                        Intent intent = new Intent(Maps3Activity.this, InfoPage.class);
                        ...
                        dist = locationA.getLatitude();

                        double ulat = locationB.getLatitude();
                        double ulng = locationB.getLongitude();

                        Intent intent1 = new Intent(Maps3Activity.this, InfoPage.class);
                        intent1.putExtra("ulat",ulat);
                        intent1.putExtra("ulng",ulng);
    ...
    private String getUrl(double latitude,double longitude,String nearByPlace)
    {
        ...
        googleURL.append("&key=" + "AIzaSyAqAMKoI7eBdpGDuzowlZ65gBu_oN9WfWE");
    ...
    public String getDistance(final double lat1, final double lon1, final double lat2, final double lon2)
    {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    URL url = new URL("http://maps.googleapis.com/maps/api/directions/json?origin=" + lat1 + "," + lon1 + "&destination=" + lat2 + "," + lon2 + "&sensor=false&units=metric&mode=driving&key" + "AIzaSyAqAMKoI7eBdpGDuzowlZ65gBu_oN9WfWE");
