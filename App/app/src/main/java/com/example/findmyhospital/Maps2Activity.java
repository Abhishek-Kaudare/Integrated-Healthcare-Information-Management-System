...
//            currentLocationMarker.remove();
    ...
    public void onClick(View v){
        String restraunts = "restraunts", bank = "bank" ,  petrol = "petrolpump" ;
        ...
        switch(v.getId())
        {
            ...
            case R.id.nearby_hotels:
                ...
                String url = getUrl(latitude,longitude,restraunts);
                transferData[0] = mMap;
                transferData[1] = url;
                ...
                mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                    ...
                    public void onInfoWindowClick(Marker marker) {
                        Intent intent = new Intent(Maps2Activity.this,InfoPage.class);
                        ...
                        dist = getDistanceMeters(locationA.getLatitude(),locationA.getLongitude(),locationB.getLatitude(),locationB.getLongitude());
            ...
            case R.id.nearby_parking:
                ...
                getNearbyPlaces.execute(transferData);
                Toast.makeText(this,"Searching For Nearby Parkings",Toast.LENGTH_SHORT).show();
