...
public class MapsActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener , OnMapReadyCallback, TaskLoadedCallback, GoogleMap.OnMyLocationButtonClickListener, GoogleMap.OnMyLocationClickListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        double ulat = intent.getDoubleExtra("lat",0);
        double ulng = intent.getDoubleExtra("lng",0);
        mMap.clear();
        Log.d("mylog", "Added Markers");
        mMap.addMarker(place1).setIcon(BitmapDescriptorFactory.fromResource(R.mipmap.user2));
        mMap.addMarker(place2).setIcon(BitmapDescriptorFactory.fromResource(R.mipmap.hospital_marker2));
...
//        Toast.makeText(this, "Current location:\n" + location, Toast.LENGTH_LONG).show();
    ...
    public void onLocationChanged(Location location) {
        ...
        float estimatedDriveTimeInMinutes = (dist / location.getSpeed());

        tvLocation.setText(String.valueOf(estimatedDriveTimeInMinutes));
//        Toast.makeText(this, msg, Toast.LENGTH_SHORT).show();
        ...
        if(isFirstTime){
            ...
            place1 = new MarkerOptions().position(new LatLng(location.getLatitude(), location.getLongitude())).title("You are here").snippet("Hi , user you are " + df.format(dist) + " KM away").zIndex(10.0f);
            place2 = new MarkerOptions().position(new LatLng(ulat,ulng)).title(hn).snippet(ha).zIndex(0.16f);
