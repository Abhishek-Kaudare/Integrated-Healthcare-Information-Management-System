...
<script src="{{ URL::asset('admin/assets/libs/flot/jquery.flot.pie.js') }}"></script>
<script src="{{ URL::asset('admin/assets/libs/flot/jquery.flot.time.js') }}"></script>
<script src="{{ URL::asset('admin/assets/libs/flot/jquery.flot.stack.js') }}"></script>
<script src="{{ URL::asset('admin/assets/libs/flot/jquery.flot.crosshair.js') }}"></script>
<script src="{{ URL::asset('admin/assets/libs/flot.tooltip/js/jquery.flot.tooltip.min.js') }}"></script>
<script src="{{ URL::asset('admin/dist/js/pages/chart/chart-page-init.js') }}"></script>
