...
<div class="login-page">
  <div class="form">
            ...
            <form class="" method="POST"  action="{{ action('BloodBank@addRegisterDetials') }}"  accept-charset="UTF-8" enctype="multipart/form-data">
                    {{ csrf_field() }}
            <input name="_token" type="hidden" value="{{ csrf_token() }}"/> 

<div class="card">
                        <div class="card-body">
                            <h2 class="card-title"style="margin-left:40%;margin-bottom:20px;color:#2255a4;font-weight:bold;font-family:Sans">Blood Bank Registration</h2>
                            <div class="form-group row">
                                    <label for="fname" class="col-md-3 m-t-15">Blood Bank Name</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="fname" placeholder="Enter Blood Bank Name" id="name" name="name" required/>
                                    </div>
                            </div>
...
<option value="Puducherry">Puducherry</option>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="fname" placeholder="Enter Blood Bank address" name="address" required>
                            </div>
