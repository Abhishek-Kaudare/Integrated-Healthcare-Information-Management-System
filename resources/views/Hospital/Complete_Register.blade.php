...
<div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="fname" placeholder="Enter pincode" name="pincode" required>
                        </div>
                            </div>
                            <div class="form-group row">
                                <label for="fname" class="col-md-3 m-t-15">Contact 1</label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="fname" placeholder="Enter contact number 1" name="con1" required>
                        </div>
                            </div>
                            <div class="form-group row">
                                <label for="fname" class="col-md-3 m-t-15">Contact 2</label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="fname" placeholder="Enter contact number 2" name="con2" required>
                        </div>
                            </div>
                            <div class="form-group row">
                                <label for="fname" class="col-md-3 m-t-15">Contact 3</label>
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="fname" placeholder="Enter contact number 3" name="con3" required>
                        </div> 
                            </div>
                            <div class="form-group row">
