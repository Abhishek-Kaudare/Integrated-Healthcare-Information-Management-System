...
class ADMIN extends Controller
{
    ...
    public function acceptHospital($id,$hosid)
    {
        ...
        DB::select($query2);            
        $query3 = "INSERT INTO `roomcount`(`id`, `hospital_id`, `room_type`, `ccount`,`price`) VALUES (null,$hosid,1,0,0)";
        $query4 = "INSERT INTO `roomcount`(`id`, `hospital_id`, `room_type`, `ccount`,`price`) VALUES (null,$hosid,2,0,0)";
        $query5 = "INSERT INTO `roomcount`(`id`, `hospital_id`, `room_type`, `ccount`,`price`) VALUES (null,$hosid,3,0,0)";
        $query6 = "INSERT INTO `roomcount`(`id`, `hospital_id`, `room_type`, `ccount`,`price`) VALUES (null,$hosid,4,0,0)";
        $query7 = "INSERT INTO `roomcount`(`id`, `hospital_id`, `room_type`, `ccount`,`price`) VALUES (null,$hosid,5,0,0)";
        $query8 = "INSERT INTO `roomcount`(`id`, `hospital_id`, `room_type`, `ccount`,`price`) VALUES (null,$hosid,6,0,0)";
        $query9 = "INSERT INTO `roomcount`(`id`, `hospital_id`, `room_type`, `ccount`,`price`) VALUES (null,$hosid,7,0,0)";
        $query10 = "INSERT INTO `roomcount`(`id`, `hospital_id`, `room_type`, `ccount`,`price`) VALUES (null,$hosid,8,0,0)";
        DB::select($query3);
        DB::select($query4);
        DB::select($query5);
        DB::select($query6);
